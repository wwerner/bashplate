...
export const Option = ({ data: option, onChange, onRemove }: OptionProps) => {
  const updatedOptions = (
    src: OptionData,
    updates: { [key: string]: boolean | string | number }
  ) => ({ ...src, ...updates });
    ...
    <tr>
      ...
      <td>
        <input
          className="input"
          name="functionCall"
          defaultValue={option.functionCall}
          onChange={handleChange}
          type="text"
          size={10}
          maxLength={30}
